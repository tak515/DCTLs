#ifndef __IDT_CANON_C500_CINEMAGAMUT_A_TRIG_H_INCLUDED__
#define __IDT_CANON_C500_CINEMAGAMUT_A_TRIG_H_INCLUDED__
...
__DEVICE__ inline float3 IDT_Canon_C500_CinemaGamut_A_Trig( float3 In)
{
